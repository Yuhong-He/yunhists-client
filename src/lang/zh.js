export default {
    ...
    profile: {
        ...
        confirmDeleteAccountInfo: "如您确认删除账户，数据库中您的邮箱、密码、用户名会被清除，您将无法登录账户，分享记录中也无法看到您的用户名。在删除前，请记下您的ID，如您希望恢复账户，请通过电子邮件联系管理员，并提供用户ID。",
        confirm: "确认",
        cancel: "取消",
        ...
        receiveEmail: "接收通知邮件",
        receiveEmailDesc: "接收论文分享成功、失败以及删除的通知邮件",
        deleteAccount: "注销账户",
        deleteAccountDesc: "数据库中您的邮箱、密码、用户名会被清除，您将无法登录账户，分享记录中也无法看到您的用户名",
    },
    util: {
        user: {
            noUser: "用户不存在，请重新登陆",
    ...
    share: {
        ...
        fileMissingBody: "您分享的论文缺少文件",
        approveNewShare: "审批分享",
        download: "下载",
        reject: "驳回",
        approvePass: "批准",
        confirmReject: "确认驳回",
