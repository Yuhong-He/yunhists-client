export default {
    ...
    profile: {
        ...
        receiveEmailDesc: "Receive notification emails for success, failure, and deletion of thesis sharing.",
        deleteAccount: "Delete Account",
        deleteAccountDesc: "Your email, password, and user name in the database will be cleared, you will not be able to log in to your account, and your user name will not be visible in the sharing records.",
    },
    util: {
        user: {
